...
namespace Dashboard.Areas.Administrator.Controllers
{
    ...
    public class ManageUsersController : Controller
    {
        ...
        public ManageUsersController(ApplicationContext db, CustomUserManager userManager, RoleManager<IdentityRole> roleManager, IOptions<IdentityDefaultOptions> options,
